    ...
    <div class="container mb-5">
        <form>
            <div class="row mt-3">
                <div class="col">
                    <!--CARTE MERE-->
                    <label for="carte-mere" class="form-label text-white fw-bold"><img width="20" src="/assets/icon/carte-mere.png" alt="icon-graphic-card" /> &nbsp;Carte Mère</label>
                ...
                <div class="col">
                    <!-- PROCESSEUR -->
                    <label for="processeur" class="form-label text-white fw-bold"><img width="20" src="/assets/icon/processor.png" alt="icon-graphic-card" /> &nbsp;Processeur</label>
            ...
            <div class="row mt-3">
                <div class="col">
                    <label for="carte-graphique" class="form-label text-white fw-bold"><img width="20" src="/assets/icon/graphic-card.png" alt="icon-graphic-card" /> &nbsp;Carte graphique</label>
            ...
            <div class="row mt-3">
                <div class="col">
                    <label for="ram" class="form-label text-white fw-bold"><img width="20" src="/assets/icon/ram.png" alt="icon-graphic-card" /> &nbsp;RAM</label>
                ...
                <div class="col">
                    <label for="stockage" class="form-label text-white fw-bold"><img width="20" src="/assets/icon/ssd.png" alt="icon-graphic-card" /> &nbsp;Stockage</label>
                ...
                <div class="col">
                    <label for="disque-sup" class="form-label text-white fw-bold"><img width="20" src="/assets/icon/disque-dur.png" alt="icon-graphic-card" /> &nbsp;Disque Suplémentaire</label>
            ...
            <div class="row mt-3">
                <div class="col">
                    <label for="boitier" class="form-label text-white fw-bold"><img width="20" src="/assets/icon/boitier.png" alt="icon-graphic-card" /> &nbsp;Boîtier</label>
            ...
            <div class="row mt-3">
                ...
                <div class="col-auto">
                    <a class="btn btn-flowtech fw-bold shadow" href="/panier">Aller au panier</a>
                </div>
            </div>
        </form>
    </div>
