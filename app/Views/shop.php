        ...
        <div class="px-4 pt-5 my-5 text-center">
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
                    <a class="btn btn-flowtech btn-lg px-4 me-sm-3" href="panier.php">Accéder au panier <img width="20" src="/assets/icon/cart.png" alt="" /> </a>
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="container mt-5">
        ...
        <div class="row">
            <div class="col-12 col-lg-3 mt-3">
                <div class="card bg-transparent border-flowtech border-1 h-100 mt-2">
                    <div class="shop-card-img">
                        <img src="/assets/img/abyssin-geforce-rtx.png" class="card-img-top" alt="..." />
                    </div>
                    <!--CARTE GRAPHIQUE-->
                    <div class="card-body d-flex flex-column">
                        <h5 class="card-title text-light text-center">PC Savana</h5>
                        <p class="card-text text-light text-center">1.949,00 €</p>
                        <p class="card-text text-light"><img width="15" src="/assets/icon/graphic-card.png" alt="Carte PC RTX" /> Nvidia Geforce-Rtx 4070ti.</p>
                        <!--PROCESSEUR-->
                        <p class="card-text text-light">
                            <img width="15" src="/assets/icon/processor.png" alt="icon-graphic-card" />
                            AMD Ryzen 7 4500 (4.1 GHz).
                        </p>
                        <!--RAM-->
                        <p class="card-text text-light">
                            <img width="15" src="/assets/icon/ram.png" alt="processor" />
                            DDR4 Corsair RGB vengeance 2x16GB 3200Mhz
                        </p>
                        <!--SSD-->
                        <p class="card-text text-light">
                            <img width="15" src="/assets/icon/ssd.png" alt="ssd-png" />
                            M2 NVME 2TO
                        </p>
                        <!--Panier-->
            ...
            <div class="col-12 col-lg-3 mt-3">
                <div class="card bg-transparent border-flowtech border-1 h-100 mt-2">
                    <div class="shop-card-img">
                        <img src="/assets/img/atlas-gforce-rtx.png" class="card-img-top" alt="..." />
                    </div>
                    <!--CARTE GRAPHIQUE-->
                    <div class="card-body d-flex flex-column">
                        <h5 class="card-title text-light text-center">PC Kraken</h5>
                        <p class="card-text text-light text-center">1.399,99 €</p>
                        <p class="card-text text-light"><img width="15" src="/assets/icon/graphic-card.png" alt="" /> Nvidia Geforce-Rtx 3O50.</p>
                        <!--PROCESSEUR-->
                        <p class="card-text text-light">
                            <img width="15" src="/assets/icon/processor.png" alt="icon-graphic-card" />
            ...
            <div class="col-12 col-lg-3 mt-3">
                <div class="card bg-transparent border-flowtech border-1 h-100 mt-2">
                    <div class="shop-card-img">
                        <img src="/assets/img/cheetoh-geforce-rtx.png" class="card-img-top" alt="..." />
                    </div>
                    <!--CARTE GRAPHIQUE-->
                    <div class="card-body d-flex flex-column">
                        <h5 class="card-title text-light text-center">PC Atlas</h5>
                        <p class="card-text text-light text-center">1.499,99 €</p>
                        <p class="card-text text-light"><img width="15" src="/assets/icon/graphic-card.png" alt="" /> Nvidia Geforce-Rtx 4060ti.</p>
                        <!--PROCESSEUR-->
                        <p class="card-text text-light">
                            <img width="15" src="/assets/icon/processor.png" alt="icon-graphic-card" />
                            AMD Ryzen 5 5700X.
            ...
            <div class="col-12 col-lg-3 mt-3">
                <div class="card bg-transparent border-flowtech border-1 h-100 mt-2">
                    <div class="shop-card-img">
                        <img src="/assets/img/fractal-north-rx.png" class="card-img-top" alt="..." />
                    </div>
                    <!--CARTE GRAPHIQUE-->
                    <div class="card-body d-flex flex-column">
        ...
        <div class="row mt-5">
            <div class="col-12 col-lg-3 mt-3">
                <div class="card bg-transparent border-flowtech border-1 h-100 mt-2">
                    <div class="shop-card-img">
                        <img src="/assets/img/french-ultimate-rtx.png" class="card-img-top" alt="..." />
                    </div>
                    <!--CARTE GRAPHIQUE-->
                    <div class="card-body d-flex flex-column">
                        <h5 class="card-title text-light text-center">PC Tracer</h5>
                        <p class="card-text text-light text-center">5.999,99 €</p>
                        <p class="card-text text-light"><img width="15" src="/assets/icon/graphic-card.png" alt="" /> Nvidia Geforce-Rtx 4090.</p>
                        <!--PROCESSEUR-->
                        <p class="card-text text-light">
                            <img width="15" src="/assets/icon/processor.png" alt="icon-graphic-card" />
            ...
            <div class="col-12 col-lg-3 mt-3">
                <div class="card bg-transparent border-flowtech border-1 h-100 mt-2">
                    <div class="shop-card-img">
                        <img src="/assets/img/frost-lian-rtx.png" class="card-img-top" alt="..." />
                    </div>
                    <!--CARTE GRAPHIQUE-->
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-12 col-lg-3 mt-3">
                <div class="card bg-transparent border-flowtech border-1 h-100 mt-2">
                    <div class="shop-card-img">
                        <img src="/assets/img/good-guy-rtx.png" class="card-img-top" alt="..." />
                    </div>
                    <!--CARTE GRAPHIQUE-->
                    <div class="card-body d-flex flex-column">
                        <h5 class="card-title text-light text-center">PC Orion</h5>
                        <p class="card-text text-light text-center">1.199,99 €</p>
                        <p class="card-text text-light"><img width="15" src="/assets/icon/graphic-card.png" alt="" /> Nvidia Geforce-Rtx 3070.</p>
                        <!--PROCESSEUR-->
                        <p class="card-text text-light">
                            <img width="15" src="/assets/icon/processor.png" alt="icon-graphic-card" />
                            Intel core i5-13600KF 5,1Ghz
            ...
            <div class="col-12 col-lg-3 mt-3">
                <div class="card bg-transparent border-flowtech border-1 h-100 mt-2">
                    <div class="shop-card-img">
                        <img src="/assets/img/orion-geforce-rtx.png" class="card-img-top" alt="..." />
                    </div>
                    <!--CARTE GRAPHIQUE-->
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text text-light"><img width="15" src="/assets/icon/graphic-card.png" alt="" /> Nvidia Geforce-Rtx 3080.</p>
                        <!--PROCESSEUR-->
                        <p class="card-text text-light">
                            <img width="15" src="/assets/icon/processor.png" alt="icon-graphic-card" />
